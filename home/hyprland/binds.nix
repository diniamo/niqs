...
in {
  wayland.windowManager.hyprland.settings = {
    bind = [
      ...
      "${mod}, n, exec, neovide"
      "${mod}${secondary}, n, exec, cd /etc/nixos && neovide -- +Oil"
      "${mod}, w, exec, firefox"
      "${mod}, q, killactive"
      ...
      "${mod}, m, togglespecialworkspace, music_gui"
      "${mod}${secondary}, m, togglespecialworkspace, music_tui"
