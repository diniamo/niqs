{
  ...
  rest.normal = {
    ...
    "Super+Control x" = "spawn '${getExe pkgs.gnome.zenity} --question --text \"Do you really want to reboot to the boot menu?\" --icon system-reboot && systemctl reboot --boot-loader-menu=2147483647'";
    # TODO: cliphist
